...
abstract class NsFFmpegExtension {
  abstract val version: Property<String>
  abstract val directoryName: Property<String>
  abstract val downloadFfprobe: Property<Boolean>
...
fun Project.nsFFmpeg(action: NsFFmpegExtension.() -> Unit) {
  configure<NsFFmpegExtension>(action)
}
