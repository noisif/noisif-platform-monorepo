...
import xyz.noisif.nsl.websocket.jetty.adapter.JettyWsHandshakeRequestAdapter;
import xyz.noisif.nsl.websocket.jetty.adapter.JettyWsListenerAdapter;
  ...
  public Object createWebSocket(
    ...
    if (principalId != null) {
      ...
      return new JettyWsListenerAdapter(
          lifecycleListener, busListener, sessionRegistry, rateLimiter, serializer, principalId);
    }
