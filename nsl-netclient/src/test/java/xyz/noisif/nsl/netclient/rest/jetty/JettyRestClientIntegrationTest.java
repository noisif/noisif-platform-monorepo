...
import xyz.noisif.nsl.netclient.rest.group.TestGroup;
import xyz.noisif.nsl.netclient.rest.intercept.CorrelationInterceptor;
import xyz.noisif.nsl.netclient.rest.intercept.SignatureInterceptor;
...
class JettyRestClientIntegrationTest {
  ...
  void shouldSendGetRequest() {
    ...
    assertThat(response.getBody().name()).isEqualTo("NOISIF");
  }
