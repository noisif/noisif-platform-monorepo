 ...
 */
package xyz.noisif.nsl.netclient.rest.jetty;
...
import xyz.noisif.nsl.netclient.rest.GenericRestClient;
import xyz.noisif.nsl.netclient.rest.jetty.spec.JettyRequestSpec;
import xyz.noisif.nsl.netclient.rest.spec.RequestSpec;
...
public class JettyRestClient extends GenericRestClient {
  ...
  public static class Builder extends GenericRestClient.AbstractBuilder<Builder> {
    ...
    public GenericRestClient build() {
      ...
      Assert.state(maxConnectionsPerHost > 0, "MaxConnectionsPerHost must be greater than zero");
      Assert.state(maxHeadersSize >= 1024, "MaxHeadersSize must be at least 1024 bytes (1KB)");
